        ...
        >
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.title} numberOfLines={1}>{coupon.title}</Text>
                {
                    !!coupon.description
                    && (
                        <Text style={styles.description} numberOfLines={3}>{coupon.description}</Text>
                    )
                }   
                
                <View
                style={[styles.statusTag, {backgroundColor: isOpen ? colors.tagOpen : colors.tagClosed}]}>
                    <Text style={styles.statusTagText} numberOfLines={1}>{isOpen ? 'Aberto agora' : 'Fechado'}</Text>
                </View>
            </View>
